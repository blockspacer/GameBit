#!/usr/bin/env python3
# Copyright (c) 2016 The GameBit Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.

from test_framework.mininode import *
from test_framework.test_framework import GameBitTestFramework
...
# TestNode: A peer we use to send messages to GameBitd, and store responses.
...
class CompactBlocksTest(GameBitTestFramework):
    def __init__(self):
        super().__init__()
    ...
    # This test actually causes GameBitd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that GameBitd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for GameBitd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # GameBitd will not send blocktxn responses for blocks whose height is
