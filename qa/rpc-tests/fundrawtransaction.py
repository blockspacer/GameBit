...
class RawTransactionsTest(GameBitTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid GameBit address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid GameBit address" in e.error['message'])
