...
unlocked to sign the GameBit-Qt.app bundle.
...
allowing somebody to distribute a GameBit-Qt.app or GameBit-qt-setup.exe with a valid
...
that the GameBit-qt.exe file inside the installer had not been tampered with.
