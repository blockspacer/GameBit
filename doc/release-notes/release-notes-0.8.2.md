GameBit-Qt version 0.8.2 is now available from:
  http://sourceforge.net/projects/GameBit/files/GameBit/GameBit-0.8.2/
...
MacOSX:
* OSX support for click-to-pay (GameBit:) links
...
* Entering the 'getblocktemplate' or 'getwork' RPC commands into the GameBit-Qt debug
console will cause GameBit-Qt to crash. Run GameBit-Qt with the -server command-line
