GameBit Core version 0.10.3 is now available from:

  <https://GameBit.org/bin/GameBit-core-0.10.3/>
...
(see https://github.com/GameBit/GameBit2/pull/6793, as well as the 0.11.0
