GameBit Core version 0.9.4 is now available from:

  https://GameBit.org/bin/0.9.4/
...
this update is incompatible with the GameBit system and could lead to consensus
forks.

GameBit Core released binaries from https://GameBit.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitcoin/+archive/ubuntu/bitcoin
- A third-party or self-compiled GameBit Core

upgrade to GameBit Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
