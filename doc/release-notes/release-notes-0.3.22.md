Download URL: https://sourceforge.net/projects/GameBit/files/GameBit/GameBit-0.3.22/
...
* IRC is overflowing.  Client now bootstraps to channels #GameBit00 - #GameBit99
