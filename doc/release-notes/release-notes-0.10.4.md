GameBit Core version 0.10.4 is now available from:

  <https://GameBit.org/bin/GameBit-core-0.10.4/>
...
- #6953 `43c2789` Split GameBit-tx into its own package
- #6953 `dfe0d4d` Include GameBit-tx binary on Debian/Ubuntu
