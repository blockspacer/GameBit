GameBit-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/GameBit/files/GameBit/GameBit-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the GameBit
...
New/changed settings (command-line or GameBit.conf file)
--------------------------------------------------------
