GameBit Core version 0.13.2 is now available from:

  <https://GameBit.org/bin/GameBit-core-0.13.2/>
...
- #8908 `4a974b2` Update GameBit-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow GameBit-tx to create v2 transactions (sysdrak)
