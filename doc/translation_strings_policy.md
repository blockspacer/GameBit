...
This document provides guidelines for internationalization of the GameBit Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `GameBit_en.ts` remains unchanged.
