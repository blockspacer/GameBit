...
#ifndef GameBit_QT_GameBitUNITS_H
#define GameBit_QT_GameBitUNITS_H
...
/** GameBit unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class GameBitUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit GameBitUnits(QObject *parent);

    /** GameBit units.
      @note Source: https://en.GameBit.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        SYS,
...
typedef GameBitUnits::Unit GameBitUnit;

#endif // GameBit_QT_GameBitUNITS_H
