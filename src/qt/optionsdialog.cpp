    ...
    mapper(0)
{
	...
	ui->zecEndPoint->setPlaceholderText("http://zec.GameBit.org:8080/");
	ui->btcEndPoint->setPlaceholderText("http://btc.GameBit.org:8080/");
    ...
    ui->GameBitAtStartup->setToolTip(ui->GameBitAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->GameBitAtStartup->setText(ui->GameBitAtStartup->text().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new GameBitUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->GameBitAtStartup, OptionsModel::StartAtStartup);
