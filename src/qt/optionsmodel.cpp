...
void OptionsModel::Init(bool resetSettings)
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", GameBitUnits::SYS);
    ...
    if (!settings.contains("zecEndPoint"))
		settings.setValue("zecEndPoint", "http://zec.GameBit.org:8080/");
    if (!settings.contains("btcEndPoint"))
        settings.setValue("btcEndPoint", "http://btc.GameBit.org:8080/");
...
void OptionsModel::checkAndMigrate()
{
    ...
    if (settingsVersion < CLIENT_VERSION)
    {
        ...
        // see https://github.com/GameBit/GameBit2/pull/8273
