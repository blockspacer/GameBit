...
#ifndef GameBit_TEST_SCRIPTNUM10_H
#define GameBit_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from GameBit Core 0.10.0, for cross-comparison.
 */
public:
