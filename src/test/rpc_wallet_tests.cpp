// Copyright (c) 2013-2015 The GameBit Core developers
...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CGameBitAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CGameBitAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CGameBitAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CGameBitAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CGameBitAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CGameBitAddress(arr[0].get_str()).Get() == demoAddress.Get());
