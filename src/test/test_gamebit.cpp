...
#define BOOST_TEST_MODULE GameBit Test Suite

#include "test_GameBit.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_GameBit_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
