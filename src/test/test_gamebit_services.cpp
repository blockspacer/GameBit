#include "test_GameBit_services.h"
#include "utiltime.h"
#include "util.h"
#include "amount.h"
...
void StartNode(const string &dataDir, bool regTest, const string& extraArgs)
{
    ...
    boost::filesystem::path fpath = boost::filesystem::system_complete("../GameBitd");
...
{
	UniValue val;
	boost::filesystem::path fpath = boost::filesystem::system_complete("../GameBit-cli");
...
BasicGameBitTestingSetup::BasicGameBitTestingSetup()
{
}
BasicGameBitTestingSetup::~BasicGameBitTestingSetup()
{
}
GameBitTestingSetup::GameBitTestingSetup()
{
	StartNodes();
}
GameBitTestingSetup::~GameBitTestingSetup()
...
GameBitMainNetSetup::GameBitMainNetSetup()
{
	StartMainNetNodes();
}
GameBitMainNetSetup::~GameBitMainNetSetup()
