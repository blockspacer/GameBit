 ...
 */
#ifndef GameBit_UTIL_H
#define GameBit_UTIL_H
...
extern const char * const GameBit_CONF_FILENAME;
extern const char * const GameBit_PID_FILENAME;
...
{
    std::string s = strprintf("GameBit-%s", name);
