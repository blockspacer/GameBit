...
#ifndef GameBit_CLIENTVERSION_H
#define GameBit_CLIENTVERSION_H
...
//! These need to be macros, as clientversion.cpp's and GameBit*-res.rc's voodoo requires it
...
#define GameBit_VERSION BUILD_VERSION(CLIENT_VERSION_MAJOR, CLIENT_VERSION_MINOR, CLIENT_VERSION_REVISION, CLIENT_VERSION_BUILD)
...
/**
 * GameBitd-res.rc includes this file, but it cannot cope with real c++ code.
...
#include <vector>
// GameBit
static const std::string GameBit_CLIENT_VERSION = GameBit_VERSION;
