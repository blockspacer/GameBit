...
// Copyright (c) 2009-2012 The GameBit Core developers
...
CMD_REGEX= "perl -pi -e 's/(20\d\d)(?:-20\d\d)? The GameBit/$1-%s The GameBit/' %s"
REGEX_CURRENT= re.compile("%s The GameBit" % year)
